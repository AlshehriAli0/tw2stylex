...
```text
/goal Migrate this codebase from Tailwind to StyleX with tw2stylex (https://github.com/AlshehriAli0/tw2stylex). Install tw2stylex if missing, run tw2stylex init, then read and follow the installed migrating-tailwind-to-stylex skill in full. Complete its whole-project migration and verification criteria.
```
